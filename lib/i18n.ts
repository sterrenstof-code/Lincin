...
const NL = {
  ...
  chats: "Gesprekken", unread: "ongelezen", newMsg: "nieuw bericht", newMsgs: "nieuwe berichten", inOneChat: "in 1 gesprek", inNChats: "in {n} gesprekken", readNow: "Lezen →", markRead: "Markeer als gelezen", markUnread: "Markeer als ongelezen", mentioned: "Vermeld", about: "over", typing: "schrijft…", writeTo: "Schrijf aan",
...
const EN: typeof NL = {
  ...
  chats: "Chats", unread: "unread", newMsg: "new message", newMsgs: "new messages", inOneChat: "in 1 chat", inNChats: "in {n} chats", readNow: "Read →", markRead: "Mark as read", markUnread: "Mark as unread", mentioned: "Mentioned", about: "about", typing: "is typing…", writeTo: "Write to",
...
const DE: typeof NL = {
  ...
  chats: "Gespräche", unread: "ungelesen", newMsg: "neue Nachricht", newMsgs: "neue Nachrichten", inOneChat: "in 1 Gespräch", inNChats: "in {n} Gesprächen", readNow: "Lesen →", markRead: "Als gelesen markieren", markUnread: "Als ungelesen markieren", mentioned: "Erwähnt", about: "über", typing: "schreibt…", writeTo: "Schreib an",
